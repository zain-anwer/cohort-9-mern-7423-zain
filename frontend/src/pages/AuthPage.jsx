            ...
            <div className="relative z-10 w-full max-w-sm sm:max-w-md bg-white rounded-xl shadow-sm border border-gray-100 p-6 sm:p-8"> 
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-4 sm:gap-5"> 
                    ...
                    <div className="flex flex-col gap-1"> 
                        ...
                        <input id="email" type='email' value={email} onChange={handleEmail} placeholder='rene.descartes@gmail.com' className="w-full rounded-md border border-gray-300 px-3 py-2 text-sm sm:text-base text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-900 focus:border-transparent"/> 
                    </div> 
                    <div className="flex flex-col gap-1"> 
                        <label htmlFor="password" className="text-sm font-medium text-gray-700">Password</label> 
                        <input id="password" type='password' value={password} onChange={handlePassword} className="w-full rounded-md border border-gray-300 px-3 py-2 text-sm sm:text-base text-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-900 focus:border-transparent"/> 
                    </div> 
